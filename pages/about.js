        ...
        <div className={commonStyles.contentWrapper}>
          ...
          <div className={cn('flexGrid', styles.container)}>
            ...
            <div className={cn(styles.text, 'col--md-7')}>
              <p>
                Hi, I'm Jos&eacute;, a Product Designer based in Munich
              ...
              <p>
                After spending over 11 years as a <strong>developer</strong> on
                ...
                unique blend of skills enables me to oversee the entire product
                lifecycle, from conception to delivery.
              </p>
              <p>
                In my free time, you'll find me reading, hiking, cooking,
                biking, bouldering, taking photos, or practicing martial arts.
                In 2018 and 2019, I embarked on a solo backpacking adventure
                across Asia, traveling for four months. I'm proud to say I've
                visited a total of{' '}
                <a
                  target="_blank"
