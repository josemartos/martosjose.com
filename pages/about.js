          ...
          <div className={cn('flexGrid', styles.container)}>
            ...
            <div className={cn(styles.text, 'col--md-7')}>
              ...
              <p>
                ...
                diverse projects and industries. After building a strong
                technical foundation, I expanded into product design to
                complement my background and deepen my understanding of
