          ...
          <div className={cn('flexGrid', styles.container)}>
            ...
            <div className={cn(styles.text, 'col--md-7')}>
              ...
              <p>
                ...
                exploring, photography, and practicing martial arts. Between
                2018 and 2019, I embarked on a four-month solo backpacking
                adventure across Asia, and I'm proud to say I have visited a
                total of{' '}
                <a
                  target="_blank"
